...
//		}
		...
		// Stream : Akış
		// Aşğ.daki örnekte ogrenciler listesinin üzerinden gidip işlemler yapmamızı sağlar. Yani akış oluşturur.
		// ogrenciler.stream() => yazdığınız zaman kaynağı ogrenciler listesi olan bir akış oluşturulur.
		//
		// Lambda functions:
		// ok -> 'un solundaki ogr parametre
		// ok -> 'un sağındaki de parametrenin çalığacağı metoddur.
		...
		// collect() metodu ile filtre sonuçlarını liste haline çevirebilliriz.
		...
		System.out.println();
		// map() metodu: map'leme işlemi ie yeni nesneler oluşturulur.
