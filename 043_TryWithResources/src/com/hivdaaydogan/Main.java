...
public class Main {
	...
	// Closeable interface'ini implement eden herhangi bir sınıfı try-with-resources kalıbı ile kullanabilirsiniz
	...
	*/
	...
	public static void main(String[] args) {
		...
		try (FileWriter writer = new FileWriter("markalar.txt",true)){
			...
			// Kullanıcı -1 girene kadar kullanıcının markayı markalar.txt dosyasına yazdırın.
			while (true) {
