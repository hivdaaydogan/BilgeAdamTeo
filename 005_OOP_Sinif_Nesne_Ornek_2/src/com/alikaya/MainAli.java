...
public class MainAli {
	...
	public static void main(String[] args) {
		...
		// paralelKenar1.isim = "benim paralelkenarım";  => erişilemez çünkü isim değişkeni private tanımlanmış
		...
		ucgen1.kenar2 = 8;
		ucgen1.kenar3 = 9;
		System.out.println("üçgen çevresi: " + ucgen1.ucgenCevresi());
		
		Ucgen ucgen2 = new Ucgen();
		ucgen2.kenar1 = 30;
		ucgen2.kenar2 = 40;
		ucgen2.kenar3 = 50;
		System.out.println("üçgen çevresi: " + ucgen2.ucgenCevresi());
		...
		daire.yaricap = 10;
		// daire.cap = 20;  ==> cap private olduğu için buradan erişilemez. 
